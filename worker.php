...
$query = "SELECT Book_ID, Book_name, Author_name, Book_describtion, Book_upload_date, usersName, usersEmail 
FROM books 
...
if ($result->num_rows > 0) {
 ...
 <tr>
   ...
   <td><a href="delete.php?Book_ID=<?php echo $data['Book_ID']; ?>">Delete</a></td>
 <tr>
 <?php
  $sn++;}} else { ?>
    <tr>
